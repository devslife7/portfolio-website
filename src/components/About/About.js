  ...
  return (
    <div className='about'>
      <div className='about__content container'>
        ...
        <a className='about__resumeLink' href='https://docs.google.com/document/d/1Cht0kQH6qNid2bBqsinMaxYOk2GjQV82-rbuGDgiakM/edit?usp=sharing' target="#" arial-label='resume link'> RESUME <LaunchIcon/></a>
        <div className='about__socialIcons'>
          <a className='about__socialIconLink' href='https://www.linkedin.com/in/marcos-velasco-1b07a7189/' target='#' arial-label='Linkedin'>
            <FaLinkedin/>
          </a>
          <a className='about__socialIconLink' href='https://github.com/devslife7' target='#' arial-label='Github'>
            <FaGithub/>
          </a>
          <a className='about__socialIconLink' href='https://medium.com/@devslife7' target='#' arial-label='Medium'>
            <FaMedium/>
          </a>
          <a className='about__socialIconLink' href='https://www.facebook.com/marcos.velasco.5/' target='#' arial-label='Facebook'>
            <FaFacebook/>
          </a>
          ...
          <a className='about__socialIconLink' href='https://twitter.com/Markuz113' target='#' arial-label='Twitter'>
            <FaTwitter/>
          </a>
        </div>
      </div>
